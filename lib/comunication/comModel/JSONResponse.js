...
class JSONResponse {
	...
	static fromObject(object) {
		...
		return new JSONResponse(JSONHelper.default.stringToDate(object.currentTimestamp ? object.currentTimestamp : object.response.currentTimestamp), object.response, object.responseCode, object.responseMessage);
	}
}
