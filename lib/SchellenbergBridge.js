			...
			switch (parsedResponse.responseCode) {
				...
				case 5:
					...
					if (parsedResponse.responseMessage.toLowerCase().includes("update")) {
						gthat.log.error(
							"Either update for SmartFriendsBox required or connection parameters are outdated. Please use the official app and check the adapter settings.",
						);
						this.handleDisconnect();
						break;
					}
