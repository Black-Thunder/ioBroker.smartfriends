			...
			switch (parsedResponse.responseCode) {
				...
				case 5:
					...
					if (parsedResponse.responseMessage.toLowerCase().includes("folgende lizenzen")) {
						gthat.log.warn("Licenses are expiring soon. Check official app for details. Ignoring this message...");
						this.sendCommand(CommandFactory.default.createCancelCmd()); // close "dialog", otherwise further commands will fail
						break;
					}
