...
class SchellenbergBridge {
	...
	async Connect() {
		SmartSocketFactory.default.createSocketAndLogin(this.ip, this.port, "CA.pem", this.username, this.password, this.cSymbol, this.shcVersion, this.shApiVersion, this, true)
			.then(returnedSocket => {
